...
- `PrescriptionPlaceholderPage` (Doctor) — opens after consultation completion succeeds. Prescription entry is not implemented yet; this page makes that limit clear and links back to the dashboard.
