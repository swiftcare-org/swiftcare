...
namespace PrescriptionService.Maintenance;
...
public static class MaintenanceCommandRunner
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var connectionString = configuration.GetConnectionString("PrescriptionDb");
        if (string.IsNullOrWhiteSpace(connectionString))
        {
            Console.Error.WriteLine("ConnectionStrings__PrescriptionDb is not configured.");
            return Failure;
        }
        ...
        await using var dbContext = new PrescriptionDbContext(options);
